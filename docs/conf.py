...
latex_documents = [
  ('index', 'HatosGanaderos.tex', u'HatosGanaderos Documentation',
   u'@mricharleon', 'manual'),
]
...
man_pages = [
    ('index', 'hatosganaderos', u'HatosGanaderos Documentation',
     [u'@mricharleon'], 1)
]
...
epub_copyright = u'2014, @mricharleon'
