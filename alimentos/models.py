...
class Food(models.Model):
    ...
    administration_route = models.PositiveSmallIntegerField(
...
class ApplicationFood(models.Model):
    ...
    cattle = models.ManyToManyField(
            Ganado, blank=True, null=True,
            related_name='application_food_food', verbose_name=u'Ganados')
