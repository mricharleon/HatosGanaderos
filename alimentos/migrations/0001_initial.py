...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'alimentos_alimento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('caduca', self.gf('django.db.models.fields.DateField')()),
            ('etapa', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('cantidad', self.gf('django.db.models.fields.IntegerField')()),
            ('ganaderia', self.gf('django.db.models.fields.related.ForeignKey')(related_name='alimentos', to=orm['profiles.Ganaderia'])),
            ('ganado', self.gf('django.db.models.fields.related.ForeignKey')(related_name='alimentos_ganado', to=orm['ganados.Ganado'])),
        ))
        db.send_create_signal(u'alimentos', ['Alimento'])


    def backwards(self, orm):
        # Deleting model 'Alimento'
        db.delete_table(u'alimentos_alimento')
    ...
    models = {
        u'alimentos.alimento': {
            ...
            'ganado': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'alimentos_ganado'", 'to': u"orm['ganados.Ganado']"}),
